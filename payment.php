                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                      <form action="./COD.php" method="POST">
                        ...
                        <input type="submit" name="COD" onclick="Get_Address()" style="padding: 5px 10px; background-image: linear-gradient(#28a0e5,#015e94);background-color: #1275ff; border: 0px solid transparent; color: white; font-weight: 600" value="Thanh toán bằng tiền mặt">
                      </form>
                  </td>
                </tr>
              </tfoot>
