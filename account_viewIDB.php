...
<body>
            ...
            <div class="row">
                <div id="account__left">
                    <ul id="setting__menu">
                        ...
                        <li>
                            <a href="#TTDH" id="TTDH" onclick="activeTTDH()" style="background-color: #ffa600;">Trạng thái đơn hàng</a>
                        </li>
                        <li>
                ...
                <div id="account__right">
                    <div id="myAccount">
                        ...
                        <div id="trangThaiDonHang" style="display: block;">
    ...
    <?php
    if (isset($_POST['dmk'])) {
        $mkc = $_POST['mkc']; //muốn mã hoá -> md5($_POST['mkc']);
        $mkm = $_POST['mkm']; //....
